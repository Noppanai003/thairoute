...
<body>
    ...
    <div class="container">
            ...
            <div class="col-sm-8 text-left">
                <form class="form-inline" name="searchform" id="searchform" action="search.php" method="get">
                    <div class="form-group">
                        <input type="text" name="itemname" id="itemname" class="form-control" value="<?php echo $_REQUEST['itemname']; ?>" placeholder="" autocomplete="off">
        ...
        $sql_query = "SELECT
                    ...
                    FROM
                    " . $config['route']['db'] . " where " . $config['route']['db'] . "." . $config['route']['db'] . "_subject" . " like '%{$itemname}%'";
        // print_pre($sql_query);
